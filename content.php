...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php the_title( '<h1 class="entry-title"><a href="' . esc_url( get_permalink() ) . '" title="' . esc_attr( sprintf( __( 'Permalink to %s', 'zoren' ), the_title_attribute( 'echo=0' ) ) ) . '" rel="bookmark">', '</a></h1>' ); ?>
	...
	<div class="entry-content clear">
		<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'zoren' ) ); ?>
		<?php
			wp_link_pages( array(
